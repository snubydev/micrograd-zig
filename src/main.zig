...
pub fn main() !void {
    ...
    // defer mlp.deinit();
    //
    // var ypred: [4]Value = undefined;
    //
    // for (0..xs.len) |i| {
    //     ypred[i] = (try mlp.call(xs[i]))[0];
    // }
    // //outs[0].backward();
    //
    // for (ypred) |yp| {
    ...
    // std.debug.print("------\n\n\n", .{});
    //
    // var loss: Value = value(0, "loss");
    // for (0..ys.len) |i| {
    //     ypred[i].grad = ypred[i].data * 2 - ys[i] * 2;
    //     ypred[i].printL();
    //     const loss_i = std.math.pow(f32, ypred[i].data - ys[i], 2);
    //     std.debug.print("loss_{d}: {d}\n", .{ i, loss_i });
    //     loss.data += loss_i;
    // }
    // loss.printL();
    //
    ...
    // // x2 -> ypred2 ---> loss
    // //
    // // x[1..n] -> mlp(w[1..n],b,grad) -> ypred1 -> loss
    // //        ypred2
    // //        ypred3
    // //        ypred4
    //
    // std.debug.print("------\n\n\n", .{});
    //
    // // mlp.layers[0].neurons[0].w[0].printL();
    // // ypred[2].backward();
